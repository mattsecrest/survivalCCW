...
- The traditional outcome variable which denotes censorship (0) or event (1) (in this case, `death`). Note that additional values are permitted to facilitate competing risks analysis.
...
- The clinical eligibility window (in this case, we'll do `182.62` days, or 6 months). **Note you can also leave this blank and define the exposure and time-to-exposure within the clinical eligibility date yourself**.
